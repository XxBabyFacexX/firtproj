    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'calendar_events_view' => $this->input->post('calendar_events_view'),
                'calendar_events_add' => $this->input->post('calendar_events_add'),
                'calendar_events_edit' => $this->input->post('calendar_events_edit'),
                'calendar_events_delete' => $this->input->post('calendar_events_delete'),
