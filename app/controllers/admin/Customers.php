...
class Customers extends MY_Controller
{
    ...
    public function get_comments($id){
        ...
        $this->datatables->select ('comment,file_name')
    ...
    function add_comment(){
        ...
        if ( ! $this->upload->do_upload('userfile'))
        {
            ...
            $this->companies_model->add_comment(NULL);
        }
        else
        {
            $data = array('upload_data' => $this->upload->data());
            $this->companies_model->add_comment($data['upload_data']['file_name']);
        }
        redirect(admin_url('customers'),'refresh');
    ...
    function edit($id = NULL)
    {
        ...
        if ($this->form_validation->run('companies/add') == true) {
            ...
            $data = array('name' => $this->input->post('name'),
                ...
                'comment_img'=>($data['upload_data']['file_name']!='')?$data['upload_data']['file_name']:$file,*/
