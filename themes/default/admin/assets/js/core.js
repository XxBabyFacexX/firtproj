...
function img_h(x) {
    var image_link = (x == null || x == '') ? 'no_image.png' : x;
    return '<div class="text-center"><a href="'+site.url+'assets/uploads/' + image_link + '" data-toggle="lightbox"><img src="'+site.url+'assets/uploads/' + image_link + '" alt="" style="width:30px; height:30px;" /></a></div>';
}
function img_h3(x) {
    var image_link = (x == null || x == '') ? 'no_image.png' : x;
    return '<div class="text-center"><a href="'+site.url+'assets/uploads/customers/' + image_link + '" data-toggle="lightbox"><img src="'+site.url+'assets/uploads/customers/' + image_link + '" alt="" style="width:30px; height:30px;" /></a></div>';
}
function link_h(x) {
    var link = (x == null || x == '') ? '' : x;
