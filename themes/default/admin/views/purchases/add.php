    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            ...
            response: function (event, ui) {
                //with the premise that ui is the container of the suggestions
                //this if blok of code will no longer run
                //because the last else if will have bwwn run before the if block becomes true
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($editInfo)) {
                    echo admin_form_open_multipart("purchases/edit/".$editInfo->id, $attrib);
                }
                else{
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('A commander','received' => lang('received'), 'pending' => lang('pending'), 'ordered' => lang('ordered'));
