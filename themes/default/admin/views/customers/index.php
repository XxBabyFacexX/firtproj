...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <?php echo form_submit('', lang(''),'style="display:none"') ?>
        </form>
        ...
        <!-- dfr -->
       <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id'=>'frm');?>
            <?= admin_form_open_multipart("customers/add_comment", $attrib)?>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <?= form_textarea('comments', (isset($rec['0']->comment)?$rec['0']->comment:''), 'class="form-control " id="details" rquired');?>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.comment', function(event) {
            ...
            $('#eid').val($(this).closest('tr').attr('id'))            
        });
