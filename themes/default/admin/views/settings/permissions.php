                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                    <td><?= lang("calendar"); ?></td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="calendar_events_view" <?php echo $p->{'calendar_events_view'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="calendar_events_add" <?php echo $p->{'calendar_events_add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="calendar_events_edit" <?php echo $p->{'calendar_events_edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox" name="calendar_events_delete" <?php echo $p->{'calendar_events_delete'} ? "checked" : ''; ?>>
                                    </td>
                                    <td>
