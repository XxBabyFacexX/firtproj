                    ...
                    <ul class="nav main-menu">
                        ...
                        <li class="mm_order">
                            <a href="<?= admin_url('order') ?>">
                                <i class="fa fa-dashboard"></i>
                                <span class="text"> <?= lang('order'); ?></span>
                            </a>
                        </li>
...
<!-- Panrubat -->
                            <li class="mm_ressources">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-star-o"></i>
                                    <span class="text"> <?= lang('Ressources'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul id='dynamicNav'>

                                    <?php if  ($Owner || $Admin) { ?>
                                        <li id="ressources_index">
                                            <a class="submenu" href="<?= admin_url('ressources'); ?>">
                                                <i class="fa fa-wrench"></i><span class="text"> <?= lang('gérer_les_liens'); ?></span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    
                                    <?php foreach ($dn as $key => $value): ?>
                                        <li id="ressources_blank">
                                            <a class="submenu" href="<?= $value['link']?>" target="_blank">
                                                <i class="fa fa-external-link"></i><span class="text"> <?= $value['title']?></span>
                                            </a>
                                        </li>  
                                    <?php endforeach ?>
...
<!-- Panrubat2 -->
                            <li class="mm_fail">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-star-o"></i>
                                    <span class="text"> <?= lang('loupés/erreurs'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                     <li id="list_fail">
                                        <a class="submenu" href="<?= admin_url('fail');?>">
                                            <i class="fa fa-star-o"></i><span class="text"><?= lang('list_loupés/erreurs'); ?></span>
                                        </a>
                                    </li>
                                    <li id="fail_add">
                                        <a class="submenu" href="<?= admin_url('fail/add'); ?>">
                                            <i class="fa fa-star-o"></i><span class="text"> <?= lang('add'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
<!-- /panrubat2 -->
                            ...
                            <?php if ($Owner) { ?>
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                       <!--  <li id="system_settings_calendar">
                                            <a href="<?= admin_url('calendar/list') ?>">
                                                <i class="fa fa-calendar"></i><span class="text"> <?= lang('calendar'); ?></span>
                                            </a>
                                        </li> -->
